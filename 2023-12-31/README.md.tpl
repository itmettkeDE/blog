...
And before you now it, you got a Stack deployed as Stackset in multiple Accounts and Regions. Find the code on [github](https://github.com/itmettkeDE/blog/blob/main/${PWD##*/}/) and try it out yourself.
